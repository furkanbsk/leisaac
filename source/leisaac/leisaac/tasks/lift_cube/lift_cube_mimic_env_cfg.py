...
from .lift_cube_env_cfg import FrankaLiftCubeEnvCfg, LiftCubeEnvCfg
...
class LiftCubeMimicEnvCfg(LiftCubeEnvCfg, MimicEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.subtask_configs[self.robot_name] = subtask_configs


@configclass
class FrankaLiftCubeMimicEnvCfg(FrankaLiftCubeEnvCfg, MimicEnvCfg):
    """Configuration for the Franka lift cube task with mimic environment."""

    def __post_init__(self):
        super().__post_init__()

        self.datagen_config.name = "lift_cube_franka_task_v0"
        self.datagen_config.generation_guarantee = True
        self.datagen_config.generation_keep_failed = True
        self.datagen_config.generation_num_trials = 10
        self.datagen_config.generation_select_src_per_subtask = True
